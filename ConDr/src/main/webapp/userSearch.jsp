                ...
                <div class="col-lg-8">
                    ...
                    <ul id="myList" class="list-unstyled">
                        <%
                            ...
                            String text1 = request.getParameter("nume_user_de_la_user");

                            System.out.println("Am intrat in ProductSearch: "+text1 );
                            ...
                            if(conn3!=null)
                                try {
                                    String query="select * from useri where lower(prenume|| ' ' ||nume) like lower('"+text1+"') or lower(nume|| ' ' ||prenume) like lower('"+text1+"') or lower(prenume) like lower('%"+text1+"%') or  lower(nume) like lower('%"+text1+"%')";
                                    ...
                                    while(rs3.next()) {
                                        ...
                                        String user_nume = rs3.getString("nume");
                                        String user_prenume = rs3.getString("prenume");
                                        ...
                                        String full_user_name=user_nume+" "+user_prenume;
                                        int user_id = rs3.getInt("userid");
                                        out.println(" <li class=\"alert alert-warning\" style=\"display:none;\">"+full_user_name+"");
                                        out.println( "<form action=\"checkProfilColeg\" method=\"POST\" class=\"pull-right\">");
                                        out.println( "<input type=\"hidden\" name=\"id_coleg\" value="+user_id+">");
                                        out.println( "<button type=\"submit\" class=\"btn btn-theme\">Check User</button>");
                                        out.println("</form>");
                                        out.println("</li>");
                                    }
